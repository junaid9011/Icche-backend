...
const upload=require('../Utlis/multer.img')
const {getProducts,newProduct,getSingleProduct,updateProduct,removeProduct, createProductReview, getProductReviews, deleteReview, getAdminProducts}=require('../controllers/productController');
...
router.route('/admin-products').get(isAuthenticatedUser,authorizedRule('admin'),getAdminProducts);
